        ...
        <Card className="group overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-linear-to-br from-white to-gray-50">
            <div className="relative h-64">
                <img
                    ...
                    alt={hero.name}
                    onClick={handleClick}
                    className="object-cover transition-all duration-500  absolute -top-7.5 w-full h-100"
                />
                ...
                >
                    <Heart
                        className={`h-4 w-4 
                        ${isFavorite(hero) ? 'fill-red-500 text-red-500' : 'fill-transparent text-gray-600'}`}
                    />
                </Button>
            ...
            <CardHeader className="py-3 z-10 bg-gray-100/50 backdrop-blur-sm relative top-1">
            ...
            <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1">
                        ...
                        <Progress value={hero.strength * 10} className="h-2" activeColor='bg-linear-to-r from-blue-600 to-orange-500' />
                    </div>
                    <div className="space-y-1">
                        <div className="flex items-center gap-1">
                        ...
                        <Progress value={hero.intelligence * 10} className="h-2" activeColor='bg-linear-to-r from-blue-500 to-blue-300' />
                    </div>
                    <div className="space-y-1">
                        <div className="flex items-center gap-1">
                        ...
                        <Progress value={hero.speed * 10} className="h-2" activeColor='bg-linear-to-r from-blue-600 to-green-500' />
                    </div>
                    <div className="space-y-1">
                        <div className="flex items-center gap-1">
                        ...
                        <Progress value={hero.durability * 10} className="h-2" activeColor='bg-linear-to-r from-blue-600 to-purple-500' />
                    </div>
                </div>
                ...
                <div className="text-xs text-gray-500 pt-2 border-t">First Appearance: {hero.firstAppearance}</div>
            </CardContent>
        </Card>
    )
}
