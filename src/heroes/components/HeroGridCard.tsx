            ...
            <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1">
                        ...
                        <Progress value={100} className="h-2" activeColor='bg-linear-to-r from-blue-600 to-orange-500' />
                    </div>
                    <div className="space-y-1">
                        <div className="flex items-center gap-1">
                        ...
                        <Progress value={80} className="h-2" activeColor='bg-linear-to-r from-blue-500 to-blue-300' />
                    </div>
                    <div className="space-y-1">
                        <div className="flex items-center gap-1">
                        ...
                        <Progress value={90} className="h-2" activeColor='bg-linear-to-r from-blue-600 to-green-500' />
                    </div>
                    <div className="space-y-1">
                        <div className="flex items-center gap-1">
                        ...
                        <Progress value={100} className="h-2" activeColor='bg-linear-to-r from-blue-600 to-purple-500' />
                    </div>
                </div>
